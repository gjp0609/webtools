...
public class RedisUtilBak {
    ...
    public Long incr(String key, long delta,long time){
        ...
        Long value = get(key)==null?null:Long.valueOf(get(key).toString());
    ...
    public Long decr(String key, long delta,long time){
        ...
        value=get(key)==null?null:Long.valueOf(get(key).toString())-delta;
        return value;
    }
     ...
     * @return
     */
    public Long hdecr(String key, String item,long by,long time){
        Long increment = redisTemplate.opsForHash().increment(key, item,-by);
        expire(key, time);
        return increment;
    }
